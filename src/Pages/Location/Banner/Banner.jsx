...
<hr />
  ...
  <div className="hero-content flex-col lg:flex-row-reverse align-middle">

  <div className="mx-auto md:w-[600px] sm:w-[500px] w-[350px] my-10" style={{ height: '500px' }}>
      <GoogleMapReact
        bootstrapURLKeys={{ key: "" }}
        defaultCenter={defaultProps.center}
        defaultZoom={defaultProps.zoom}
    ...
    <div style={{ height: '500px', width: '390px' }} className="card md:-me-4 flex-shrink-0  shadow-xl bg-base-100   md:w-[600px] sm:w-[500px] w-[350px]">
      <div className="card-body">
      <div className="flex justify-between align-middle">
        <input type="text" placeholder="Enter address or zipcode.."></input>
        <>
        <FaSistrix className="inline -me-16"></FaSistrix>
        <span className="text-blue-500 inline">Fiilter</span>
        </>
        </div>
<hr />
