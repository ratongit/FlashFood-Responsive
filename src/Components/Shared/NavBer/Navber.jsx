...
const Navber = () => {
  ...
  const nabitem = <>
    ...
    <li><a className='hover:text-white text-white   font-semibold text-md'>How it works</a></li>
    ...
    <li><a className='hover:text-white text-white   font-semibold text-md'> Support</a></li>
